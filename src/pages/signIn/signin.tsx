...
export const SignIn = () => {
  ...
  return (
    <div className="w-screen h-screen flex bg-black items-center text-white">
        ...
        <div id="logo" className="mx-auto">
          <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
            ...
            <g id="页面-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
              <g id="Development" transform="translate(0.000000, -48.000000)" fillRule="nonzero">
